...
export class RunboxCalendarEvent implements CalendarEvent {
    ...
    clone(): RunboxCalendarEvent {
        // clone the jcal as it is mutable
        // http://mozilla-comm.github.io/ical.js/api/ICAL.Component.html#toJSON
        const jcal = JSON.parse(JSON.stringify(this.event.component.toJSON()));

        return new RunboxCalendarEvent(this.id, jcal);
    }
