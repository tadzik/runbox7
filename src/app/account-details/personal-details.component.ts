...
export class PersonalDetailsComponent {
    ...
    details: Subject<AccountDetails> = new Subject();
    ...
    constructor(
        ...
        this.details.subscribe((details: AccountDetails) => {
    ...
    private loadDetails() {
        this.http.get('/rest/v1/account/details').pipe(
    ...
    public update() {
        ...
        this.http.post('/rest/v1/account/details', updates).pipe(
            map((res: HttpResponse<any>) => res['result'])
        ).subscribe(details => {
            this.details.next(details);
        });
